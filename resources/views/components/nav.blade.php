...
@endif
  <ol class="list-none text-2xl mt-12 font-light">
    <li class="mt-4"><a href="{{ route('home') }}">home</a></li>
    <li class="mt-4"><a href="{{ route('login') }}">sign in</a></li>
    <li class="mt-4"><a href="{{ route('register') }}">sign up</a></li>
    <li class="mt-4"><a href="{{ route('dashboard') }}">my panel</a></li>
